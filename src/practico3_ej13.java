...
public class practico3_ej13 {
    public static void main(String args[]) {
        // Dado un número, un máximo y un mínimo (recibido por parámetro), retorne verdadero si el número esta dentro del máximo y el mínimo.
